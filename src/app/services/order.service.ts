...
makeOrderRest(obj):Observable<object>{
  this.httpOptions = {
   ...
   return this.http.post("http://20.40.242.130:4500/orders/all",obj,this.httpOptions)
} 

getOrdersByUsername():Observable<object>{
  let user=sessionStorage.getItem("username");
  return this.http.get("http://20.40.242.130:4500/orders/all/"+user);
}

getOrders():Observable<object>{

  return this.http.get("http://20.40.242.130:4500/orders/all/");
}
}
